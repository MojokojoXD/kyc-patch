...
export default function IndividualFormIntro({
	...
	return (
		<>
            ...
            <FormContent className='flex flex-col '>
                <CustomProgress disable maxSteps={1} currentStep={0}/>
				<div className='row-span-3 max-w-prose leading-relaxed h-60 overflow-y-scroll text-base font-normal my-5 text-neutral-700 p-5 grow space-y-3'>
					<p>
