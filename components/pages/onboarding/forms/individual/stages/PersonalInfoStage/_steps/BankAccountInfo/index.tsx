...
export const BankAccountInfo: FormStep = ({ applicantCount, countryList }) => {
...
function BankForm({ applicantId, countryList = [], bankList }: BankFormProps) {
	...
	const currentBankCountry = watch(`applicant.${applicantId}.bank.country`);
	...
	const aggregatorResults = useMemo(() => {
		...
		!isPriorityCountry &&
			aggregator.modifyFields(`applicant.${applicantId}.bank.name`, (f) => {
				return {
					...f,
					fieldType: 'text',
