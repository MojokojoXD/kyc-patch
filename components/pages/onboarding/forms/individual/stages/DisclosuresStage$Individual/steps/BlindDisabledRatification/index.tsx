...
function RatificationForm({
    ...
    const { form: { register } } = useKYCFormContext<IndividualFormSchema>();
				...
				<div className='py-4 pl-4 bg-neutral-50 border border-neutral-100 rounded-lg space-y-[12px] text-neutral-700'>
					...
					<p className='paragraph2Regular text-base leading-10'>
						...
						<Input
							...
							readOnly
						/>{' '}
						understood and approved of the contents before appending his/her signature
						below and executing the form.
					</p>
				</div>
			</div>
		</>
