...
import { proofOfIdentityModel$Signatories } from './model/proofOfIdentity$SignatoriesModel';

export const ProofOfIdentity$Signatories: FormStep = () => {
...
function SignatoryForm({ applicantId }: SignatoryFormProps) {
	const fields = proofOfIdentityModel$Signatories({
		index: applicantId,
	});
