...
const collateBeneficalOwnersFromSignatories = ( signatories: Signatory[] ): BeneficialOwner[] => {
...
export const BeneficialOwners: FormStep = ({ countryList }) => {
	...
	const currentBeneficialOwners =
		(getValues('accountSignatories.beneficialOwners') as BeneficialOwner[]) ;


	useEffect(() => {
		let beneficialOwnersFromSignatories = collateBeneficalOwnersFromSignatories(signatories);
