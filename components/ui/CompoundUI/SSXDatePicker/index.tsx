...
export const SSXDatePicker = ({
	...
	const trackDocumentScroll = useCallback(function (e: Event) {
		const elementNode = calendarPopoverRef.current!;
		...
		const clickOutside = function (e: MouseEvent) {
			...
			if (e.target instanceof Node) {
                ...
                if ( !isDescendant )
                {
                    ...
                    document.removeEventListener('scroll', trackDocumentScroll);
                };
			}
		};
					...
					<input
						...
						onClick={() => {
							setIsCalendarOpen((prevState) => {
								...
								} else document.removeEventListener('scroll', trackDocumentScroll);
